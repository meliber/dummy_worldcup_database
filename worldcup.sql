...
--
-- Name: games fk_games_teams_oppoent; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_games_teams_oppoent FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);
